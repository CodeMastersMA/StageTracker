...
export function cardLoad(list){
    ...
    {list.forEach(element => {
        ...
        card.innerHTML=`
        <div id="cards"><div class="card" style="width: 18rem;">
        ...
        <div class="card-body"><h2 id="title">${element.title_fr}</h2><p class="card-text" id="desc">${element.description_fr}</p></div></div></div>
        `
